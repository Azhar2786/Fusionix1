...
const ConversationError = () => {
  ...
  return (
    <div className="h-full grid grid-cols-1 justify-items-center content-center ">
        <p className="text-displayLarge font-semibold">{error.code}</p>

        <p className="text-light-onSurfaceVariant dark:text-dark-onSurfaceVariant mt-2 mb-4">{error.message}</p>
